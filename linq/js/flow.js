const allStories = [
  {
    thumbUrl: "src/assets/flow/1-thumb.png",
    imageUrl: "src/assets/flow/1.png",
    title: "Title No. 1",
  },

  {
    thumbUrl: "src/assets/flow/2-thumb.png",
    imageUrl: "src/assets/flow/2.png",
    title: "Title No. 2",
  },

  {
    thumbUrl: "src/assets/flow/3-thumb.png",
    imageUrl: "src/assets/flow/3.png",
    title: "Title No. 3",
  },

  {
    thumbUrl: "src/assets/flow/4-thumb.png",
    imageUrl: "src/assets/flow/4.png",
    title: "Title No. 4",
  },

  {
    thumbUrl: "src/assets/flow/5-thumb.png",
    imageUrl: "src/assets/flow/5.png",
    title: "Title No. 5",
  },

  {
    thumbUrl: "src/assets/flow/6-thumb.png",
    imageUrl: "src/assets/flow/6.png",
    title: "Title No. 6",
  },

  {
    thumbUrl: "src/assets/flow/7-thumb.png",
    imageUrl: "src/assets/flow/7.png",
    title: "Title No. 7",
  },

  {
    thumbUrl: "src/assets/flow/8-thumb.png",
    imageUrl: "src/assets/flow/8.png",
    title: "Title No. 8",
  },
];
